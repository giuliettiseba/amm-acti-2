...
export default function DialogCrearUsuario({ open, onClose, onSuccess }: DialogCrearUsuarioProps) {
  ...
  function handleClose() {
    setForm({
      username: '', password: '', confirmPassword: '', firstName: '', lastName: '', phoneNumber: '', email: '', company: ''
    });
    setError(null);
    setSuccess(false);
    onClose();
  ...
  return (
    ...
    >
      ...
      <DialogActions>
        ...
        <Button onClick={handleSubmit} variant="contained" disabled={loading} startIcon={loading ? <CircularProgress size={18} /> : null}>
          Crear usuario
        </Button>
      </DialogActions>
    </Dialog>
